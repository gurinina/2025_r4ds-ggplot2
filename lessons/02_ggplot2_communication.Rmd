...
```{r}
# Your code here - create a label data frame and use geom_text()
...
```{r}
# Your code here - add geom_text and faceting
...
```{r}
# Demonstrate with code if helpful
...
`ggplot2` includes eight themes, with `theme_gray()` as the default.
